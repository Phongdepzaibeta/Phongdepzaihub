...
function Update:Window(text,logo,keybind)
	...
	Logo.Image = "rbxassetid://9478562327"

	local Name = Instance.new("TextLabel")
	Name.Name = "phongdepzai"
	Name.Parent = phongdepzai
	...
	Hub.Name = "phongdepzai"
	Hub.Parent = phongdepzai
	Hub.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
	Hub.BackgroundTransparency = 1.000
	Hub.Position = UDim2.new(0, 086, 0, 0)
	Hub.Size = UDim2.new(0, 81, 0, 27)
	Hub.Font = Enum.Font.GothamSemibold
	Hub.Text = "       phongdepzai premium"
...
-------------------------------------------------------------------------------------------------------------------------
--Tab
local PadoUi = Update:Window("phongdepzai","",Enum.KeyCode.RightControl);
